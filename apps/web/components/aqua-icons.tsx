 ...
 *
 * Icons with no PNG yet (PillIcon/Components, PrefsIcon) keep their SVG; so does
 * the menu-bar SearchGlyph.
 */
"use client"
...
/** Gel heart — tone-matched. Favourites + About. */
...
/** Patina brand mark — a pink gel star, recoloured per tone via the
    ...
    Zero-JS tone technique. Used for the menu-bar mark, the Dock Finder tile and
    the About hero. */
...
/** Spotlight magnifier for the menu bar. */
export function SearchGlyph(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" width={14} height={14} aria-hidden="true" {...props}>
      <circle cx="6.5" cy="6.5" r="4.5" stroke="currentColor" strokeWidth="1.8" fill="none" />
